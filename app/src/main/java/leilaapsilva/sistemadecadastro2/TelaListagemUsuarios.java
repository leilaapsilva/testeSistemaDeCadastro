...
public class TelaListagemUsuarios {
    ...
    public void CarregarTela()  {
        //Quando clicamos no botão "Listar usuários cadastrados",
        // antes de carregar a tela, verifica se existe registros
        // inseridos
        if(act.getRegistros().size() == 0)   {  //Se a condição for verdadeira, não existe nenhum
            //usuário cadastrado, então irá mostrar a mensagem abaixo
